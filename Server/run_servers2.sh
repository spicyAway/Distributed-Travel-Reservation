...
#TODO: SPECIFY THE HOSTNAMES OF 4 CS MACHINES SEPARATED BY SPACES e.g (lab1-1.cs.mcgil.ca open-4.cs.mcgill.ca etc...)
MACHINES=(cs-29.cs.mcgill.ca cs-30.cs.mcgill.ca cs-31.cs.mcgill.ca cs-32.cs.mcgill.ca)
